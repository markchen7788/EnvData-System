...
function createStyle(num) {
    ...
    return "background:url(../code/Mark/src/main/resources/static/res/index_bg" + num + ".jpg) top left;background-size:100%; margin: 0px;padding: 0px;height: 100%;overflow-y: hidden;opacity:0.9;"
}
function changeBg() {
    current_bg_num++;
